...
async def run():
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.fill("input[id='first_name']", "grei")
            await page.fill("input[id='last_name']", "18th")
            await page.fill("input[id='address1']", "Unity estate badore")
            await page.fill("input[id='state']", "Lagos")
            await page.fill("input[id='city']", "lekki")
